import { ExternalLink, Github, GitCompareArrows } from "lucide-react";
...
const SIDE_PROJECTS: SideProjectProps[] = [
...

  {
    ...
    technologies: ["Node.js", "Express", "MongoDB", "API REST"],
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center">
        <h2 id="projects-title" className="mt-2 text-3xl font-bold md:text-4xl">
          Projets sélectionnés
        </h2>

        <p className="mt-4 leading-7 text-muted-foreground">
          Une sélection de projets personnels et de formation illustrant mon
          évolution et mes compétences en développement web.
        </p>
      </div>
