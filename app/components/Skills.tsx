...
const skillCategories = [
...

  {
    title: "UI & Styling",
    icon: Palette,
    skills: ["Tailwind CSS", "SCSS", "shadcn/ui", "Responsive Design"],
  },
...

  {
    ...
    icon: Wrench,
    skills: ["ESLint", "Prettier", "Tests", "SEO", "Accessibilité"],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h2 id="skills-title" className="mt-2 text-3xl font-bold md:text-4xl">
          Technologies et outils que j&apos;utilise
        </h2>

        <p className="max-w-2xl mx-auto mt-4 text-muted-foreground">
          Un socle principalement orienté Front-End, avec une ouverture vers le
      ...
      <div className="max-w-3xl p-6 mx-auto mt-8 border rounded-lg">
        <h3 className="text-xl font-semibold">IA & productivité</h3>

        <p className="mt-3 leading-7 text-muted-foreground">
          J&apos;utilise les outils d&apos;assistance IA comme support dans mon
          développement pour accélérer la recherche, la compréhension du code,
          le debugging, la documentation et certaines tâches répétitives, tout
          en vérifiant et validant les résultats.
        </p>
      </div>
    </section>
  );
