    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="mt-5 leading-7 text-muted-foreground">
          ...
          principalement orienté Front-End ou Full Stack.
        </p>
        ...
        <div className="grid gap-4 mt-8 sm:grid-cols-3">
          <div className="p-4 border rounded-lg">
            <p className="text-sm text-muted-foreground">Contrat recherché</p>

            <p className="mt-1 font-semibold">CDI</p>
          </div>

          <div className="p-4 border rounded-lg">
            <p className="text-sm text-muted-foreground">Localisation</p>

            <p className="mt-1 font-semibold">Rouen et alentours</p>
          </div>

          <div className="p-4 border rounded-lg">
            <p className="text-sm text-muted-foreground">Télétravail</p>

            <p className="mt-1 font-semibold">100 % remote privilégié</p>
          </div>
        </div>
